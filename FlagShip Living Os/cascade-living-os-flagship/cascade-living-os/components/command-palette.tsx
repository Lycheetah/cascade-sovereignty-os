...
export function CommandPalette() {
  ...
  const commands: Command[] = [
    ...
    { id: 'nav-today', label: 'Go to Today', icon: '☀️', category: 'navigation', action: () => router.push('/today') },
    { id: 'nav-flow', label: 'Go to Flow', icon: '🌊', category: 'navigation', action: () => router.push('/flow') },
    ...
    { id: 'nav-focus', label: 'Go to Focus Mode', icon: '🎯', category: 'navigation', action: () => router.push('/focus') },
    { id: 'nav-breathe', label: 'Go to Breathwork', icon: '💨', category: 'navigation', action: () => router.push('/breathe') },
    { id: 'nav-energy', label: 'Go to Energy Tracker', icon: '🔋', category: 'navigation', action: () => router.push('/energy') },
    { id: 'nav-rituals', label: 'Go to Rituals', icon: '🔄', category: 'navigation', action: () => router.push('/rituals') },
    { id: 'nav-goals', label: 'Go to Goals', icon: '🎯', category: 'navigation', action: () => router.push('/goals') },
    { id: 'nav-projections', label: 'Go to Projections', icon: '📈', category: 'navigation', action: () => router.push('/projections') },
    { id: 'nav-decisions', label: 'Go to Decisions', icon: '❓', category: 'navigation', action: () => router.push('/decisions') },
    { id: 'nav-commitments', label: 'Go to Commitments', icon: '✓', category: 'navigation', action: () => router.push('/commitments') },
    { id: 'nav-connections', label: 'Go to Connections', icon: '👥', category: 'navigation', action: () => router.push('/connections') },
    { id: 'nav-values', label: 'Go to Values', icon: '💜', category: 'navigation', action: () => router.push('/values') },
    { id: 'nav-review', label: 'Go to Weekly Review', icon: '📋', category: 'navigation', action: () => router.push('/review') },
    { id: 'nav-patterns', label: 'Go to Patterns', icon: '📊', category: 'navigation', action: () => router.push('/patterns') },
    { id: 'nav-insights', label: 'Go to Insights', icon: '💡', category: 'navigation', action: () => router.push('/insights') },
    { id: 'nav-search', label: 'Go to Search', icon: '🔍', category: 'navigation', action: () => router.push('/search') },
    { id: 'nav-memory', label: 'Go to Memory', icon: '🧠', category: 'navigation', action: () => router.push('/memory') },
    ...
    { id: 'nav-reality', label: 'Go to Reality Bridge', icon: '🌉', category: 'navigation', action: () => router.push('/reality') },
    ...
    { id: 'nav-backup', label: 'Go to Backup', icon: '💾', category: 'navigation', action: () => router.push('/backup') },
    ...
    { id: 'action-focus', label: 'Start Focus Session', description: 'Begin deep work', icon: '🎯', category: 'action', shortcut: 'F', action: () => router.push('/focus') },
    { id: 'action-breathe', label: 'Start Breathwork', description: 'Guided breathing', icon: '💨', category: 'action', shortcut: 'B', action: () => router.push('/breathe') },
    ...
    { id: 'action-review', label: 'Weekly Review', description: 'Reflect on the week', icon: '📋', category: 'action', shortcut: 'R', action: () => router.push('/review') },
    { id: 'action-search', label: 'Search', description: 'Search all data', icon: '🔍', category: 'action', shortcut: 'S', action: () => router.push('/search') },
    { id: 'action-backup', label: 'Export Backup', description: 'Download your data', icon: '💾', category: 'action', action: () => router.push('/backup') },
    ...
    { id: 'system-export', label: 'Export Data', description: 'Download your CASCADE state', icon: '📤', category: 'system', action: () => router.push('/backup') },
